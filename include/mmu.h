...
#define PTE_R		0x0400	// 'D': Write Enable bit
...
/*
 ...
 a						~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~							 |
 a                      |                            |                           |
 a       FDDATALIM*		+----------------------------+------------0x6800 0000    | 
 a                      |      File Data Buffer      |    PDMAP/FD               |
 a       FILEBASE ----> +----------------------------+------------0x6000 0000    | 
 a                      |   File Descriptor Table    |     PDMAP                 |
 a       FDTABLE  ----> +----------------------------+------------0x5fc0 0000    |
 a                      |                            |                           |
 a						~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~							 |
 a						~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~							 |
 a                      |                            |                           |
 a       DISKLIM* ----> +----------------------------+------------0x5000 0000    | 
 a                      |     Disk Data Mapping      |                           |
 a       DISKMAP  ----> +----------------------------+------------0x1000 0000    |
 a                      |    FS Server Recv Buffer   |     BY2PG                 |
 a        REQVA   ----> +----------------------------+------------0x0fff f000    |
 a                      |                            |                           |
 a						~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~							 |
 a                      ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~                           |
